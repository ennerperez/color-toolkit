...
namespace System
{
    namespace Drawing
    {
        ...
        public static class Swatch
        {
            ...
            public static List<Color> ReadSwatchFile(string fileName)
            {
            ...
            public static List<Color> ReadSwatches(Stream stream, FileVersion version)
            {
                int colorCount;
                List<Color> results;
            ...
            public static List<Color> ReadExchangeFile(string fileName)
            {
